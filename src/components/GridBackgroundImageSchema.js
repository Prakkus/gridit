...
export const GridBackgroundImageSchema =  (schemaIndex, onValueClicked) => {
	...
	const Render = () => {
        ...
        for (let index = 0; index < schemaValues.length; index++) {
			...
			buttonElement.style.backgroundImage = `url('${schemaValues[index].imageDataUrl}')`;
        }        
	}
...
export default GridBackgroundImageSchema;
